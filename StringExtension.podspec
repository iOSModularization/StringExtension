...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.1'
  s.summary          = 'A short description of StringExtension.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/iOSModularization/StringExtension'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ivsall2012' => 'ivsall2012@gmail.com' }
  s.source           = { :git => 'https://github.com/iOSModularization/StringExtension.git', :tag => s.version.to_s }
